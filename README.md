...
application which manages a grid of data, including doing simple
calculations using [MathJS](https://mathjs.org/).
...
- [https://mathjs.org/](https://mathjs.org/) - MathJS, math library for JavaScript.
